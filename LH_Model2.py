...
data_dir = "/Users/spienaar/Desktop/Deformations Research/ML Model/LHdatasetAugX12/"
image_height = 128
image_width = 256
batch_size = 252 
epochs = 30
...
for train_index, val_index in kf.split(X):
    ...
    model.save(str('LH_ModelFinal'+'_f'+str(fold)+'_v'+ str(round(val_acc*100)) +'.h5'))
    fold += 1
