...
data_dir = "/Users/spienaar/Desktop/Deformations Research/ML Model/EMdatasetAugX12/"
image_height = 128
image_width = 256
batch_size = 252 
epochs=30
...
for train_index, val_index in kf.split(X):
    ...
    # Collect accuracies for graph generation
    ...
    model.save(str('EM_ModelFinal'+'_f'+str(fold)+'_v'+ str(round(val_acc*100)) +'.h5'))
    fold += 1
...
plt.xlabel('Epochs')
plt.ylabel('Accuracy')
plt.title('Extrusion Multiplier Model')
